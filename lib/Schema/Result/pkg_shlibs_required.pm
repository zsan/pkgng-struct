use utf8;
package Schema::Result::pkg_shlibs_required;
...
=head1 TABLE: C<pkg_shlibs_required>

=cut

__PACKAGE__->table("pkg_shlibs_required");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:R2fS9e/RrdSqsmNFV3HV3w
