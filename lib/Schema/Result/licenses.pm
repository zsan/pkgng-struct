use utf8;
package Schema::Result::licenses;
...
Composing rels: L</pkg_licenses> -> package

=cut

__PACKAGE__->many_to_many("packages", "pkg_licenses", "package");


# Created by DBIx::Class::Schema::Loader v0.07042 @ 2014-11-13 17:00:18
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QwtILu1hr7Ys4MHKRieizg
