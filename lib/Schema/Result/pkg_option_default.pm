use utf8;
package Schema::Result::pkg_option_default;
...
=head1 TABLE: C<pkg_option_default>

=cut

__PACKAGE__->table("pkg_option_default");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DAAM7YLieNBqfzgYr13CFQ
